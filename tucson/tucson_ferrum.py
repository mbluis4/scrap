...
for page_number in range(1,14):
    tucson_ferrum_total.append(f'https://tienda.tucsonsa.com/search/page/{page_number}/?q=ferrum&results_only=true&limit=12&theme=amazonas')


for page in tucson_ferrum_total:
    try:
