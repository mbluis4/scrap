...
for page_number in range(1,12):
    tucson_roca_total.append(f'https://tienda.tucsonsa.com/search/page/{page_number}/?q=roca&results_only=true&limit=12&theme=amazonas')


for page in tucson_roca_total:
    try:
