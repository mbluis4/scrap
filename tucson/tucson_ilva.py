...
for page_number in range(1,6):
    tucson_ilva_total.append(f'https://tienda.tucsonsa.com/search/page/{page_number}/?q=ilva&results_only=true&limit=12&theme=amazonas')


for page in tucson_ilva_total:
    try:
